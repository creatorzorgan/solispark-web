            ...
            <body className="min-h-screen font-sans bg-[#FAF9F6] text-[#0A192F]">
                ...
                <div className="fixed bottom-5 right-5 z-50 flex flex-col gap-3">
                    ...
                    <a
                        ...
                        className="group w-14 h-14 rounded-full btn-gold flex items-center justify-center shadow-[0_10px_30px_rgba(255,183,3,0.45)] hover:scale-110 hover:shadow-[0_15px_40px_rgba(255,183,3,0.6)] transition-all"
                    >
